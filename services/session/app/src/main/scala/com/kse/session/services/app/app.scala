...
package com.kse.session.services.app
...
class ServerProgram[F[_]: Effect] extends ServerBoot[F] {
  ...
  override def serverProgram(
    ...
    implicit val PS: com.kse.session.services.server.SessionServiceHandler[F] = new com.kse.session.services.server.SessionServiceHandler[F]
